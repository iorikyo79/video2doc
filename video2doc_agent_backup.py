...
# Video2DocWorkflow 클래스는 core.workflow로 이동됨
# @tool 함수들은 core.tools로 이동됨
...
"""
        ...
        workflow = Video2DocWorkflow()
        return workflow.report_processor.generate_fallback_report(context_file, report_type, length, context_content)
